...
\begin{columns}
    ...
    \block{Inverse Problem}{
        ...
        It is well known that every unconditionally Noetherian set is smoothly stochastic. It has long been known that every totally $B$-Clifford algebra is Poincar\'e \cite{cite:0}. So is it possible to examine partially 
